...
pub const MACOS: &str = r###"/* Reusable macOS light skin. Load before application layout/overrides. */
label {
    height: 20px;
}
...
"###;
pub const WINDOWS_11: &str = r###"/* Reusable Windows 11 Fluent skin. Load before application layout/overrides. */
label {
    height: 22px;
}
...
"###;
pub const WINDOWS_XP: &str = r###"/* Reusable Windows XP Luna skin. Load before application layout/overrides. */
label {
    height: 26px;
}
