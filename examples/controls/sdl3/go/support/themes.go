...
const themeMACOS = `/* Reusable macOS light skin. Load before application layout/overrides. */
label {
    height: 20px;
}
...
`
const themeWINDOWS_11 = `/* Reusable Windows 11 Fluent skin. Load before application layout/overrides. */
label {
    height: 22px;
}
...
`
const themeWINDOWS_XP = `/* Reusable Windows XP Luna skin. Load before application layout/overrides. */
label {
    height: 26px;
}
